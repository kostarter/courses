...
- Configuration : Priorisation dynamique, modification du flow at runtime, back pressure...
- Traçabilité des données.
- Extensible : Possibilité de créer ses propres processors/scripts.
...
Ils sont responsables de la récupération de données, et appliquent dessus des transformations, et des régles de routage... Il peuvent être planifiés par timer ou par cron.<br/>
...
Ils tournent en paralléle (ce sont des threads).
...
On peut aussi créer des variables directement dans Nifi via l'interface avec un clic droit sur l'arrière plan du board.
...
Load Balancing Strategy : Distribuer à travers le cluster ou pas ? Le plus utilisé est le Round Robin pour distribuer equitablement.
