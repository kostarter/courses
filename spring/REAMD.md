...
![Software Layers](img/screenshot_from_2023-06-21_17-24-08.png)
...
CommandLineRunner : Needs to implement a run method which is executed when Spring Application is launched.<br/>
...
![Data Access](img/screenshot_from_2023-06-21_17-24-47.png)
...
![Caching](img/screenshot_from_2023-06-21_17-27-35.png)

### Spring MVC :

![MVC](img/screenshot_from_2023-06-21_15-34-07.png)
...
![Spring MVC](img/screenshot_from_2023-06-21_15-36-55.png)
...
<br/><br/>
![Spring Bean Lifecycle](img/screenshot_from_2023-06-22_15-37-16.png)

Call back Interfaces that can be implemented for call back events :

- InitilizeBean.afterPropertiesSet() : Called after properties are set.
...
![Spring Bean Lifecycle](img/screenshot_from_2023-06-22_15-38-51.png)
...
![Spring Framework Stereotypes](img/screenshot_from_2023-06-22_16-34-16.png)
...
To look outside of the default package : 
```java
...
![Pet Clinic Application](img/screenshot_from_2023-06-21_17-30-58.png)
